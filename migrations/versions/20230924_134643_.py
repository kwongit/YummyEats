...
Revision ID: 036964ddaed4
Revises: 
Create Date: 2023-09-24 13:46:43.929324
...
def upgrade():
    ...
    sa.Column('open_hours', sa.String(length=30), nullable=False),
    sa.Column('close_hours', sa.String(length=30), nullable=False),
