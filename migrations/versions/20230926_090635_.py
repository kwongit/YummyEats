...
Revision ID: 63825c6d6191
Revises: 
Create Date: 2023-09-26 09:06:35.705636
...
def upgrade():
    ...
    sa.Column('open_hours', sa.String(length=5), nullable=True),
    sa.Column('close_hours', sa.String(length=5), nullable=True),
