...
Revision ID: d435269eb507
Revises: 
Create Date: 2023-09-26 09:13:05.217101
...
def upgrade():
    ...
    sa.Column('open_hours', sa.String(length=5), nullable=False),
    sa.Column('close_hours', sa.String(length=5), nullable=False),
